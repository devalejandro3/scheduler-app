...
<ul id="menu2">
	<li >
  		<a href="/scheduler-app/index.php/Default_Controller/homePage">Home</a>
  </li>
</ul>
</div>
	  ...
	  <li>
	    ...
	    <ul>
	      <!-- <li class="ui-state-disabled"><a href="#">Section</a></li> -->
	       ...
	       <li><a href="/scheduler-app/index.php/Maintenance/SubjectController/subject">Subject</a></li>
	       <li><a href="#">Faculty</a>
	       		<ul>
	       			<li><a href="#">Personal Information</a></li>
			       <li><a href="#">Faculty Status</a></li>
